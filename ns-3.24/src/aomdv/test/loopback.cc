 ...
 * \ingroup aomdv
 *
 * \brief AOMDV loopback UDP echo test case
 */
...
// Test suite
//-----------------------------------------------------------------------------
class AomdvLoopbackTestSuite : public TestSuite
{
public:
  AomdvLoopbackTestSuite () : TestSuite ("routing-aomdv-loopback", SYSTEM)
  {
    SetDataDir (NS_TEST_SOURCEDIR);
    // UDP Echo loopback test case
    AddTestCase (new LoopbackTestCase (), TestCase::QUICK);
  }
} g_aomdvLoopbackTestSuite;
