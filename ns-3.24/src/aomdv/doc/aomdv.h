...
/**
 * \defgroup aomdv AOMDV Routing
 *
 * This section documents the API of the ns-3 AOMDV module. For a generic functional description, please refer to the ns-3 manual.
 */
