...
def module_init():
    root_module = Module('ns.aomdv', cpp_namespace='::ns3')
    return root_module
...
def register_types(module):
    ...
    ## aomdv-helper.h (module 'aomdv'): ns3::AomdvHelper [class]
    module.add_class('AomdvHelper', parent=root_module['ns3::Ipv4RoutingHelper'])
    ...
    ## Register a nested module for the namespace aomdv
    
    nested_module = module.add_cpp_namespace('aomdv')
    register_types_ns3_aomdv(nested_module)
...
def register_types_ns3_aomdv(module):
    root_module = module.get_root()
    
    ## aomdv-packet.h (module 'aomdv'): ns3::aomdv::MessageType [enumeration]
    module.add_enum('MessageType', ['AOMDVTYPE_RREQ', 'AOMDVTYPE_RREP', 'AOMDVTYPE_RERR', 'AOMDVTYPE_RREP_ACK'])
    ## aomdv-rtable.h (module 'aomdv'): ns3::aomdv::RouteFlags [enumeration]
    module.add_enum('RouteFlags', ['VALID', 'INVALID', 'IN_SEARCH'])
    ## aomdv-dpd.h (module 'aomdv'): ns3::aomdv::DuplicatePacketDetection [class]
    module.add_class('DuplicatePacketDetection')
    ## aomdv-id-cache.h (module 'aomdv'): ns3::aomdv::IdCache [class]
    module.add_class('IdCache')
    ## aomdv-neighbor.h (module 'aomdv'): ns3::aomdv::Neighbors [class]
    module.add_class('Neighbors')
    ## aomdv-neighbor.h (module 'aomdv'): ns3::aomdv::Neighbors::Neighbor [struct]
    module.add_class('Neighbor', outer_class=root_module['ns3::aomdv::Neighbors'])
    ## aomdv-rqueue.h (module 'aomdv'): ns3::aomdv::QueueEntry [class]
    module.add_class('QueueEntry')
    ## aomdv-rqueue.h (module 'aomdv'): ns3::aomdv::RequestQueue [class]
    module.add_class('RequestQueue')
    ## aomdv-packet.h (module 'aomdv'): ns3::aomdv::RerrHeader [class]
    module.add_class('RerrHeader', parent=root_module['ns3::Header'])
    ## aomdv-routing-protocol.h (module 'aomdv'): ns3::aomdv::RoutingProtocol [class]
    module.add_class('RoutingProtocol', parent=root_module['ns3::Ipv4RoutingProtocol'])
    ## aomdv-rtable.h (module 'aomdv'): ns3::aomdv::RoutingTable [class]
    module.add_class('RoutingTable')
    ## aomdv-rtable.h (module 'aomdv'): ns3::aomdv::RoutingTableEntry [class]
    module.add_class('RoutingTableEntry')
    ## aomdv-packet.h (module 'aomdv'): ns3::aomdv::RrepAckHeader [class]
    module.add_class('RrepAckHeader', parent=root_module['ns3::Header'])
    ## aomdv-packet.h (module 'aomdv'): ns3::aomdv::RrepHeader [class]
    module.add_class('RrepHeader', parent=root_module['ns3::Header'])
    ## aomdv-packet.h (module 'aomdv'): ns3::aomdv::RreqHeader [class]
    module.add_class('RreqHeader', parent=root_module['ns3::Header'])
    ## aomdv-packet.h (module 'aomdv'): ns3::aomdv::TypeHeader [class]
...
def register_methods(root_module):
    ...
    register_Ns3AomdvHelper_methods(root_module, root_module['ns3::AomdvHelper'])
    ...
    register_Ns3AomdvDuplicatePacketDetection_methods(root_module, root_module['ns3::aomdv::DuplicatePacketDetection'])
    register_Ns3AomdvIdCache_methods(root_module, root_module['ns3::aomdv::IdCache'])
    register_Ns3AomdvNeighbors_methods(root_module, root_module['ns3::aomdv::Neighbors'])
    register_Ns3AomdvNeighborsNeighbor_methods(root_module, root_module['ns3::aomdv::Neighbors::Neighbor'])
    register_Ns3AomdvQueueEntry_methods(root_module, root_module['ns3::aomdv::QueueEntry'])
    register_Ns3AomdvRequestQueue_methods(root_module, root_module['ns3::aomdv::RequestQueue'])
    register_Ns3AomdvRerrHeader_methods(root_module, root_module['ns3::aomdv::RerrHeader'])
    register_Ns3AomdvRoutingProtocol_methods(root_module, root_module['ns3::aomdv::RoutingProtocol'])
    register_Ns3AomdvRoutingTable_methods(root_module, root_module['ns3::aomdv::RoutingTable'])
    register_Ns3AomdvRoutingTableEntry_methods(root_module, root_module['ns3::aomdv::RoutingTableEntry'])
    register_Ns3AomdvRrepAckHeader_methods(root_module, root_module['ns3::aomdv::RrepAckHeader'])
    register_Ns3AomdvRrepHeader_methods(root_module, root_module['ns3::aomdv::RrepHeader'])
    register_Ns3AomdvRreqHeader_methods(root_module, root_module['ns3::aomdv::RreqHeader'])
    register_Ns3AomdvTypeHeader_methods(root_module, root_module['ns3::aomdv::TypeHeader'])
    return
...
def register_Ns3AomdvHelper_methods(root_module, cls):
    ## aomdv-helper.h (module 'aomdv'): ns3::AomdvHelper::AomdvHelper(ns3::AomdvHelper const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::AomdvHelper const &', 'arg0')])
    ## aomdv-helper.h (module 'aomdv'): ns3::AomdvHelper::AomdvHelper() [constructor]
    cls.add_constructor([])
    ## aomdv-helper.h (module 'aomdv'): int64_t ns3::AomdvHelper::AssignStreams(ns3::NodeContainer c, int64_t stream) [member function]
    cls.add_method('AssignStreams', 
                   'int64_t', 
                   [param('ns3::NodeContainer', 'c'), param('int64_t', 'stream')])
    ## aomdv-helper.h (module 'aomdv'): ns3::AomdvHelper * ns3::AomdvHelper::Copy() const [member function]
    cls.add_method('Copy', 
                   'ns3::AomdvHelper *', 
                   [], 
                   is_const=True, is_virtual=True)
    ## aomdv-helper.h (module 'aomdv'): ns3::Ptr<ns3::Ipv4RoutingProtocol> ns3::AomdvHelper::Create(ns3::Ptr<ns3::Node> node) const [member function]
    cls.add_method('Create', 
                   'ns3::Ptr< ns3::Ipv4RoutingProtocol >', 
                   [param('ns3::Ptr< ns3::Node >', 'node')], 
                   is_const=True, is_virtual=True)
    ## aomdv-helper.h (module 'aomdv'): void ns3::AomdvHelper::Set(std::string name, ns3::AttributeValue const & value) [member function]
    cls.add_method('Set', 
                   'void', 
                   [param('std::string', 'name'), param('ns3::AttributeValue const &', 'value')])
    return
...
def register_Ns3AomdvDuplicatePacketDetection_methods(root_module, cls):
    ## aomdv-dpd.h (module 'aomdv'): ns3::aomdv::DuplicatePacketDetection::DuplicatePacketDetection(ns3::aomdv::DuplicatePacketDetection const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::aomdv::DuplicatePacketDetection const &', 'arg0')])
    ## aomdv-dpd.h (module 'aomdv'): ns3::aomdv::DuplicatePacketDetection::DuplicatePacketDetection(ns3::Time lifetime) [constructor]
    cls.add_constructor([param('ns3::Time', 'lifetime')])
    ## aomdv-dpd.h (module 'aomdv'): ns3::Time ns3::aomdv::DuplicatePacketDetection::GetLifetime() const [member function]
    cls.add_method('GetLifetime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## aomdv-dpd.h (module 'aomdv'): bool ns3::aomdv::DuplicatePacketDetection::IsDuplicate(ns3::Ptr<ns3::Packet const> p, ns3::Ipv4Header const & header) [member function]
    cls.add_method('IsDuplicate', 
                   'bool', 
                   [param('ns3::Ptr< ns3::Packet const >', 'p'), param('ns3::Ipv4Header const &', 'header')])
    ## aomdv-dpd.h (module 'aomdv'): void ns3::aomdv::DuplicatePacketDetection::SetLifetime(ns3::Time lifetime) [member function]
    cls.add_method('SetLifetime', 
                   'void', 
                   [param('ns3::Time', 'lifetime')])
    return

def register_Ns3AomdvIdCache_methods(root_module, cls):
    ## aomdv-id-cache.h (module 'aomdv'): ns3::aomdv::IdCache::IdCache(ns3::aomdv::IdCache const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::aomdv::IdCache const &', 'arg0')])
    ## aomdv-id-cache.h (module 'aomdv'): ns3::aomdv::IdCache::IdCache(ns3::Time lifetime) [constructor]
    cls.add_constructor([param('ns3::Time', 'lifetime')])
    ## aomdv-id-cache.h (module 'aomdv'): ns3::Time ns3::aomdv::IdCache::GetLifeTime() const [member function]
    cls.add_method('GetLifeTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## aomdv-id-cache.h (module 'aomdv'): uint32_t ns3::aomdv::IdCache::GetSize() [member function]
    cls.add_method('GetSize', 
                   'uint32_t', 
                   [])
    ## aomdv-id-cache.h (module 'aomdv'): bool ns3::aomdv::IdCache::IsDuplicate(ns3::Ipv4Address addr, uint32_t id) [member function]
    cls.add_method('IsDuplicate', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'addr'), param('uint32_t', 'id')])
    ## aomdv-id-cache.h (module 'aomdv'): void ns3::aomdv::IdCache::Purge() [member function]
    cls.add_method('Purge', 
                   'void', 
                   [])
    ## aomdv-id-cache.h (module 'aomdv'): void ns3::aomdv::IdCache::SetLifetime(ns3::Time lifetime) [member function]
    cls.add_method('SetLifetime', 
                   'void', 
                   [param('ns3::Time', 'lifetime')])
    return

def register_Ns3AomdvNeighbors_methods(root_module, cls):
    ## aomdv-neighbor.h (module 'aomdv'): ns3::aomdv::Neighbors::Neighbors(ns3::aomdv::Neighbors const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::aomdv::Neighbors const &', 'arg0')])
    ## aomdv-neighbor.h (module 'aomdv'): ns3::aomdv::Neighbors::Neighbors(ns3::Time delay) [constructor]
    cls.add_constructor([param('ns3::Time', 'delay')])
    ## aomdv-neighbor.h (module 'aomdv'): void ns3::aomdv::Neighbors::AddArpCache(ns3::Ptr<ns3::ArpCache> arg0) [member function]
    cls.add_method('AddArpCache', 
                   'void', 
                   [param('ns3::Ptr< ns3::ArpCache >', 'arg0')])
    ## aomdv-neighbor.h (module 'aomdv'): void ns3::aomdv::Neighbors::Clear() [member function]
    cls.add_method('Clear', 
                   'void', 
                   [])
    ## aomdv-neighbor.h (module 'aomdv'): void ns3::aomdv::Neighbors::DelArpCache(ns3::Ptr<ns3::ArpCache> arg0) [member function]
    cls.add_method('DelArpCache', 
                   'void', 
                   [param('ns3::Ptr< ns3::ArpCache >', 'arg0')])
    ## aomdv-neighbor.h (module 'aomdv'): ns3::Callback<void, ns3::Ipv4Address, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> ns3::aomdv::Neighbors::GetCallback() const [member function]
    cls.add_method('GetCallback', 
                   ...
                   [], 
                   is_const=True)
    ## aomdv-neighbor.h (module 'aomdv'): ns3::Time ns3::aomdv::Neighbors::GetExpireTime(ns3::Ipv4Address addr) [member function]
    cls.add_method('GetExpireTime', 
                   'ns3::Time', 
                   [param('ns3::Ipv4Address', 'addr')])
    ## aomdv-neighbor.h (module 'aomdv'): ns3::Callback<void, ns3::WifiMacHeader const&, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> ns3::aomdv::Neighbors::GetTxErrorCallback() const [member function]
    cls.add_method('GetTxErrorCallback', 
                   ...
                   [], 
                   is_const=True)
    ## aomdv-neighbor.h (module 'aomdv'): bool ns3::aomdv::Neighbors::IsNeighbor(ns3::Ipv4Address addr) [member function]
    cls.add_method('IsNeighbor', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'addr')])
    ## aomdv-neighbor.h (module 'aomdv'): void ns3::aomdv::Neighbors::Purge() [member function]
    cls.add_method('Purge', 
                   'void', 
                   [])
    ## aomdv-neighbor.h (module 'aomdv'): void ns3::aomdv::Neighbors::ScheduleTimer() [member function]
    cls.add_method('ScheduleTimer', 
                   'void', 
                   [])
    ## aomdv-neighbor.h (module 'aomdv'): void ns3::aomdv::Neighbors::SetCallback(ns3::Callback<void, ns3::Ipv4Address, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> cb) [member function]
    ...
    ## aomdv-neighbor.h (module 'aomdv'): void ns3::aomdv::Neighbors::Update(ns3::Ipv4Address addr, ns3::Time expire) [member function]
    cls.add_method('Update', 
                   'void', 
                   [param('ns3::Ipv4Address', 'addr'), param('ns3::Time', 'expire')])
    return

def register_Ns3AomdvNeighborsNeighbor_methods(root_module, cls):
    ## aomdv-neighbor.h (module 'aomdv'): ns3::aomdv::Neighbors::Neighbor::Neighbor(ns3::aomdv::Neighbors::Neighbor const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::aomdv::Neighbors::Neighbor const &', 'arg0')])
    ## aomdv-neighbor.h (module 'aomdv'): ns3::aomdv::Neighbors::Neighbor::Neighbor(ns3::Ipv4Address ip, ns3::Mac48Address mac, ns3::Time t) [constructor]
    cls.add_constructor([param('ns3::Ipv4Address', 'ip'), param('ns3::Mac48Address', 'mac'), param('ns3::Time', 't')])
    ## aomdv-neighbor.h (module 'aomdv'): ns3::aomdv::Neighbors::Neighbor::close [variable]
    cls.add_instance_attribute('close', 'bool', is_const=False)
    ## aomdv-neighbor.h (module 'aomdv'): ns3::aomdv::Neighbors::Neighbor::m_expireTime [variable]
    cls.add_instance_attribute('m_expireTime', 'ns3::Time', is_const=False)
    ## aomdv-neighbor.h (module 'aomdv'): ns3::aomdv::Neighbors::Neighbor::m_hardwareAddress [variable]
    cls.add_instance_attribute('m_hardwareAddress', 'ns3::Mac48Address', is_const=False)
    ## aomdv-neighbor.h (module 'aomdv'): ns3::aomdv::Neighbors::Neighbor::m_neighborAddress [variable]
    cls.add_instance_attribute('m_neighborAddress', 'ns3::Ipv4Address', is_const=False)
    return

def register_Ns3AomdvQueueEntry_methods(root_module, cls):
    cls.add_binary_comparison_operator('==')
    ## aomdv-rqueue.h (module 'aomdv'): ns3::aomdv::QueueEntry::QueueEntry(ns3::aomdv::QueueEntry const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::aomdv::QueueEntry const &', 'arg0')])
    ## aomdv-rqueue.h (module 'aomdv'): ns3::aomdv::QueueEntry::QueueEntry(ns3::Ptr<ns3::Packet const> pa=0, ns3::Ipv4Header const & h=ns3::Ipv4Header(), ns3::Callback<void, ns3::Ptr<ns3::Ipv4Route>, ns3::Ptr<ns3::Packet const>, ns3::Ipv4Header const&, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> ucb=ns3::Callback<void, ns3::Ptr<ns3::Ipv4Route>, ns3::Ptr<const ns3::Packet>, const ns3::Ipv4Header&, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>(), ns3::Callback<void, ns3::Ptr<ns3::Packet const>, ns3::Ipv4Header const&, ns3::Socket::SocketErrno, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> ecb=ns3::Callback<void, ns3::Ptr<const ns3::Packet>, const ns3::Ipv4Header&, ns3::Socket::SocketErrno, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>(), ns3::Time exp=ns3::Simulator::Now( )) [constructor]
    ...
    ## aomdv-rqueue.h (module 'aomdv'): ns3::Callback<void, ns3::Ptr<ns3::Packet const>, ns3::Ipv4Header const&, ns3::Socket::SocketErrno, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> ns3::aomdv::QueueEntry::GetErrorCallback() const [member function]
    cls.add_method('GetErrorCallback', 
                   ...
                   [], 
                   is_const=True)
    ## aomdv-rqueue.h (module 'aomdv'): ns3::Time ns3::aomdv::QueueEntry::GetExpireTime() const [member function]
    cls.add_method('GetExpireTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## aomdv-rqueue.h (module 'aomdv'): ns3::Ipv4Header ns3::aomdv::QueueEntry::GetIpv4Header() const [member function]
    cls.add_method('GetIpv4Header', 
                   'ns3::Ipv4Header', 
                   [], 
                   is_const=True)
    ## aomdv-rqueue.h (module 'aomdv'): ns3::Ptr<ns3::Packet const> ns3::aomdv::QueueEntry::GetPacket() const [member function]
    cls.add_method('GetPacket', 
                   'ns3::Ptr< ns3::Packet const >', 
                   [], 
                   is_const=True)
    ## aomdv-rqueue.h (module 'aomdv'): ns3::Callback<void, ns3::Ptr<ns3::Ipv4Route>, ns3::Ptr<ns3::Packet const>, ns3::Ipv4Header const&, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> ns3::aomdv::QueueEntry::GetUnicastForwardCallback() const [member function]
    cls.add_method('GetUnicastForwardCallback', 
                   ...
                   [], 
                   is_const=True)
    ## aomdv-rqueue.h (module 'aomdv'): void ns3::aomdv::QueueEntry::SetErrorCallback(ns3::Callback<void, ns3::Ptr<ns3::Packet const>, ns3::Ipv4Header const&, ns3::Socket::SocketErrno, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> ecb) [member function]
    ...
    ## aomdv-rqueue.h (module 'aomdv'): void ns3::aomdv::QueueEntry::SetExpireTime(ns3::Time exp) [member function]
    cls.add_method('SetExpireTime', 
                   'void', 
                   [param('ns3::Time', 'exp')])
    ## aomdv-rqueue.h (module 'aomdv'): void ns3::aomdv::QueueEntry::SetIpv4Header(ns3::Ipv4Header h) [member function]
    cls.add_method('SetIpv4Header', 
                   'void', 
                   [param('ns3::Ipv4Header', 'h')])
    ## aomdv-rqueue.h (module 'aomdv'): void ns3::aomdv::QueueEntry::SetPacket(ns3::Ptr<ns3::Packet const> p) [member function]
    cls.add_method('SetPacket', 
                   'void', 
                   [param('ns3::Ptr< ns3::Packet const >', 'p')])
    ## aomdv-rqueue.h (module 'aomdv'): void ns3::aomdv::QueueEntry::SetUnicastForwardCallback(ns3::Callback<void, ns3::Ptr<ns3::Ipv4Route>, ns3::Ptr<ns3::Packet const>, ns3::Ipv4Header const&, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> ucb) [member function]
...
def register_Ns3AomdvRequestQueue_methods(root_module, cls):
    ## aomdv-rqueue.h (module 'aomdv'): ns3::aomdv::RequestQueue::RequestQueue(ns3::aomdv::RequestQueue const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::aomdv::RequestQueue const &', 'arg0')])
    ## aomdv-rqueue.h (module 'aomdv'): ns3::aomdv::RequestQueue::RequestQueue(uint32_t maxLen, ns3::Time routeToQueueTimeout) [constructor]
    cls.add_constructor([param('uint32_t', 'maxLen'), param('ns3::Time', 'routeToQueueTimeout')])
    ## aomdv-rqueue.h (module 'aomdv'): bool ns3::aomdv::RequestQueue::Dequeue(ns3::Ipv4Address dst, ns3::aomdv::QueueEntry & entry) [member function]
    cls.add_method('Dequeue', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst'), param('ns3::aomdv::QueueEntry &', 'entry')])
    ## aomdv-rqueue.h (module 'aomdv'): void ns3::aomdv::RequestQueue::DropPacketWithDst(ns3::Ipv4Address dst) [member function]
    cls.add_method('DropPacketWithDst', 
                   'void', 
                   [param('ns3::Ipv4Address', 'dst')])
    ## aomdv-rqueue.h (module 'aomdv'): bool ns3::aomdv::RequestQueue::Enqueue(ns3::aomdv::QueueEntry & entry) [member function]
    cls.add_method('Enqueue', 
                   'bool', 
                   [param('ns3::aomdv::QueueEntry &', 'entry')])
    ## aomdv-rqueue.h (module 'aomdv'): bool ns3::aomdv::RequestQueue::Find(ns3::Ipv4Address dst) [member function]
    cls.add_method('Find', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst')])
    ## aomdv-rqueue.h (module 'aomdv'): uint32_t ns3::aomdv::RequestQueue::GetMaxQueueLen() const [member function]
    cls.add_method('GetMaxQueueLen', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## aomdv-rqueue.h (module 'aomdv'): ns3::Time ns3::aomdv::RequestQueue::GetQueueTimeout() const [member function]
    cls.add_method('GetQueueTimeout', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## aomdv-rqueue.h (module 'aomdv'): uint32_t ns3::aomdv::RequestQueue::GetSize() [member function]
    cls.add_method('GetSize', 
                   'uint32_t', 
                   [])
    ## aomdv-rqueue.h (module 'aomdv'): void ns3::aomdv::RequestQueue::SetMaxQueueLen(uint32_t len) [member function]
    cls.add_method('SetMaxQueueLen', 
                   'void', 
                   [param('uint32_t', 'len')])
    ## aomdv-rqueue.h (module 'aomdv'): void ns3::aomdv::RequestQueue::SetQueueTimeout(ns3::Time t) [member function]
    cls.add_method('SetQueueTimeout', 
                   'void', 
                   [param('ns3::Time', 't')])
    return

def register_Ns3AomdvRerrHeader_methods(root_module, cls):
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## aomdv-packet.h (module 'aomdv'): ns3::aomdv::RerrHeader::RerrHeader(ns3::aomdv::RerrHeader const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::aomdv::RerrHeader const &', 'arg0')])
    ## aomdv-packet.h (module 'aomdv'): ns3::aomdv::RerrHeader::RerrHeader() [constructor]
    cls.add_constructor([])
    ## aomdv-packet.h (module 'aomdv'): bool ns3::aomdv::RerrHeader::AddUnDestination(ns3::Ipv4Address dst, uint32_t seqNo) [member function]
    cls.add_method('AddUnDestination', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst'), param('uint32_t', 'seqNo')])
    ## aomdv-packet.h (module 'aomdv'): void ns3::aomdv::RerrHeader::Clear() [member function]
    cls.add_method('Clear', 
                   'void', 
                   [])
    ## aomdv-packet.h (module 'aomdv'): uint32_t ns3::aomdv::RerrHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## aomdv-packet.h (module 'aomdv'): uint8_t ns3::aomdv::RerrHeader::GetDestCount() const [member function]
    cls.add_method('GetDestCount', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## aomdv-packet.h (module 'aomdv'): ns3::TypeId ns3::aomdv::RerrHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## aomdv-packet.h (module 'aomdv'): bool ns3::aomdv::RerrHeader::GetNoDelete() const [member function]
    cls.add_method('GetNoDelete', 
                   'bool', 
                   [], 
                   is_const=True)
    ## aomdv-packet.h (module 'aomdv'): uint32_t ns3::aomdv::RerrHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## aomdv-packet.h (module 'aomdv'): static ns3::TypeId ns3::aomdv::RerrHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## aomdv-packet.h (module 'aomdv'): void ns3::aomdv::RerrHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## aomdv-packet.h (module 'aomdv'): bool ns3::aomdv::RerrHeader::RemoveUnDestination(std::pair<ns3::Ipv4Address,unsigned int> & un) [member function]
    cls.add_method('RemoveUnDestination', 
                   'bool', 
                   [param('std::pair< ns3::Ipv4Address, unsigned int > &', 'un')])
    ## aomdv-packet.h (module 'aomdv'): void ns3::aomdv::RerrHeader::Serialize(ns3::Buffer::Iterator i) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'i')], 
                   is_const=True, is_virtual=True)
    ## aomdv-packet.h (module 'aomdv'): void ns3::aomdv::RerrHeader::SetNoDelete(bool f) [member function]
    cls.add_method('SetNoDelete', 
                   'void', 
                   [param('bool', 'f')])
    return

def register_Ns3AomdvRoutingProtocol_methods(root_module, cls):
    ## aomdv-routing-protocol.h (module 'aomdv'): ns3::aomdv::RoutingProtocol::RoutingProtocol(ns3::aomdv::RoutingProtocol const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::aomdv::RoutingProtocol const &', 'arg0')])
    ## aomdv-routing-protocol.h (module 'aomdv'): ns3::aomdv::RoutingProtocol::RoutingProtocol() [constructor]
    cls.add_constructor([])
    ## aomdv-routing-protocol.h (module 'aomdv'): int64_t ns3::aomdv::RoutingProtocol::AssignStreams(int64_t stream) [member function]
    cls.add_method('AssignStreams', 
                   'int64_t', 
                   [param('int64_t', 'stream')])
    ## aomdv-routing-protocol.h (module 'aomdv'): void ns3::aomdv::RoutingProtocol::DoDispose() [member function]
    cls.add_method('DoDispose', 
                   'void', 
                   [], 
                   is_virtual=True)
    ## aomdv-routing-protocol.h (module 'aomdv'): bool ns3::aomdv::RoutingProtocol::GetBroadcastEnable() const [member function]
    cls.add_method('GetBroadcastEnable', 
                   'bool', 
                   [], 
                   is_const=True)
    ## aomdv-routing-protocol.h (module 'aomdv'): bool ns3::aomdv::RoutingProtocol::GetDesinationOnlyFlag() const [member function]
    cls.add_method('GetDesinationOnlyFlag', 
                   'bool', 
                   [], 
                   is_const=True)
    ## aomdv-routing-protocol.h (module 'aomdv'): bool ns3::aomdv::RoutingProtocol::GetGratuitousReplyFlag() const [member function]
    cls.add_method('GetGratuitousReplyFlag', 
                   'bool', 
                   [], 
                   is_const=True)
    ## aomdv-routing-protocol.h (module 'aomdv'): bool ns3::aomdv::RoutingProtocol::GetHelloEnable() const [member function]
    cls.add_method('GetHelloEnable', 
                   'bool', 
                   [], 
                   is_const=True)
    ## aomdv-routing-protocol.h (module 'aomdv'): uint32_t ns3::aomdv::RoutingProtocol::GetMaxQueueLen() const [member function]
    cls.add_method('GetMaxQueueLen', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## aomdv-routing-protocol.h (module 'aomdv'): ns3::Time ns3::aomdv::RoutingProtocol::GetMaxQueueTime() const [member function]
    cls.add_method('GetMaxQueueTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## aomdv-routing-protocol.h (module 'aomdv'): static ns3::TypeId ns3::aomdv::RoutingProtocol::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## aomdv-routing-protocol.h (module 'aomdv'): void ns3::aomdv::RoutingProtocol::NotifyAddAddress(uint32_t interface, ns3::Ipv4InterfaceAddress address) [member function]
    cls.add_method('NotifyAddAddress', 
                   'void', 
                   [param('uint32_t', 'interface'), param('ns3::Ipv4InterfaceAddress', 'address')], 
                   is_virtual=True)
    ## aomdv-routing-protocol.h (module 'aomdv'): void ns3::aomdv::RoutingProtocol::NotifyInterfaceDown(uint32_t interface) [member function]
    cls.add_method('NotifyInterfaceDown', 
                   'void', 
                   [param('uint32_t', 'interface')], 
                   is_virtual=True)
    ## aomdv-routing-protocol.h (module 'aomdv'): void ns3::aomdv::RoutingProtocol::NotifyInterfaceUp(uint32_t interface) [member function]
    cls.add_method('NotifyInterfaceUp', 
                   'void', 
                   [param('uint32_t', 'interface')], 
                   is_virtual=True)
    ## aomdv-routing-protocol.h (module 'aomdv'): void ns3::aomdv::RoutingProtocol::NotifyRemoveAddress(uint32_t interface, ns3::Ipv4InterfaceAddress address) [member function]
    cls.add_method('NotifyRemoveAddress', 
                   'void', 
                   [param('uint32_t', 'interface'), param('ns3::Ipv4InterfaceAddress', 'address')], 
                   is_virtual=True)
    ## aomdv-routing-protocol.h (module 'aomdv'): void ns3::aomdv::RoutingProtocol::PrintRoutingTable(ns3::Ptr<ns3::OutputStreamWrapper> stream) const [member function]
    cls.add_method('PrintRoutingTable', 
                   'void', 
                   [param('ns3::Ptr< ns3::OutputStreamWrapper >', 'stream')], 
                   is_const=True, is_virtual=True)
    ## aomdv-routing-protocol.h (module 'aomdv'): bool ns3::aomdv::RoutingProtocol::RouteInput(ns3::Ptr<ns3::Packet const> p, ns3::Ipv4Header const & header, ns3::Ptr<const ns3::NetDevice> idev, ns3::Callback<void, ns3::Ptr<ns3::Ipv4Route>, ns3::Ptr<ns3::Packet const>, ns3::Ipv4Header const&, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> ucb, ns3::Callback<void,ns3::Ptr<ns3::Ipv4MulticastRoute>,ns3::Ptr<const ns3::Packet>,const ns3::Ipv4Header&,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty> mcb, ns3::Callback<void,ns3::Ptr<const ns3::Packet>,const ns3::Ipv4Header&,unsigned int,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty> lcb, ns3::Callback<void, ns3::Ptr<ns3::Packet const>, ns3::Ipv4Header const&, ns3::Socket::SocketErrno, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> ecb) [member function]
    cls.add_method('RouteInput', 
                   'bool', 
                   [param('ns3::Ptr< ns3::Packet const >', 'p'), param('ns3::Ipv4Header const &', 'header'), param('ns3::Ptr< ns3::NetDevice const >', 'idev'), param('ns3::Callback< void, ns3::Ptr< ns3::Ipv4Route >, ns3::Ptr< ns3::Packet const >, ns3::Ipv4Header const &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'ucb'), param('ns3::Callback< void, ns3::Ptr< ns3::Ipv4MulticastRoute >, ns3::Ptr< ns3::Packet const >, ns3::Ipv4Header const &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'mcb'), param('ns3::Callback< void, ns3::Ptr< ns3::Packet const >, ns3::Ipv4Header const &, unsigned int, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'lcb'), param('ns3::Callback< void, ns3::Ptr< ns3::Packet const >, ns3::Ipv4Header const &, ns3::Socket::SocketErrno, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'ecb')], 
                   is_virtual=True)
    ## aomdv-routing-protocol.h (module 'aomdv'): ns3::Ptr<ns3::Ipv4Route> ns3::aomdv::RoutingProtocol::RouteOutput(ns3::Ptr<ns3::Packet> p, ns3::Ipv4Header const & header, ns3::Ptr<ns3::NetDevice> oif, ns3::Socket::SocketErrno & sockerr) [member function]
    cls.add_method('RouteOutput', 
                   'ns3::Ptr< ns3::Ipv4Route >', 
                   [param('ns3::Ptr< ns3::Packet >', 'p'), param('ns3::Ipv4Header const &', 'header'), param('ns3::Ptr< ns3::NetDevice >', 'oif'), param('ns3::Socket::SocketErrno &', 'sockerr')], 
                   is_virtual=True)
    ## aomdv-routing-protocol.h (module 'aomdv'): void ns3::aomdv::RoutingProtocol::SetBroadcastEnable(bool f) [member function]
    cls.add_method('SetBroadcastEnable', 
                   'void', 
                   [param('bool', 'f')])
    ## aomdv-routing-protocol.h (module 'aomdv'): void ns3::aomdv::RoutingProtocol::SetDesinationOnlyFlag(bool f) [member function]
    cls.add_method('SetDesinationOnlyFlag', 
                   'void', 
                   [param('bool', 'f')])
    ## aomdv-routing-protocol.h (module 'aomdv'): void ns3::aomdv::RoutingProtocol::SetGratuitousReplyFlag(bool f) [member function]
    cls.add_method('SetGratuitousReplyFlag', 
                   'void', 
                   [param('bool', 'f')])
    ## aomdv-routing-protocol.h (module 'aomdv'): void ns3::aomdv::RoutingProtocol::SetHelloEnable(bool f) [member function]
    cls.add_method('SetHelloEnable', 
                   'void', 
                   [param('bool', 'f')])
    ## aomdv-routing-protocol.h (module 'aomdv'): void ns3::aomdv::RoutingProtocol::SetIpv4(ns3::Ptr<ns3::Ipv4> ipv4) [member function]
    cls.add_method('SetIpv4', 
                   'void', 
                   [param('ns3::Ptr< ns3::Ipv4 >', 'ipv4')], 
                   is_virtual=True)
    ## aomdv-routing-protocol.h (module 'aomdv'): void ns3::aomdv::RoutingProtocol::SetMaxQueueLen(uint32_t len) [member function]
    cls.add_method('SetMaxQueueLen', 
                   'void', 
                   [param('uint32_t', 'len')])
    ## aomdv-routing-protocol.h (module 'aomdv'): void ns3::aomdv::RoutingProtocol::SetMaxQueueTime(ns3::Time t) [member function]
    cls.add_method('SetMaxQueueTime', 
                   'void', 
                   [param('ns3::Time', 't')])
    ## aomdv-routing-protocol.h (module 'aomdv'): ns3::aomdv::RoutingProtocol::AOMDV_PORT [variable]
    cls.add_static_attribute('AOMDV_PORT', 'uint32_t const', is_const=True)
    ## aomdv-routing-protocol.h (module 'aomdv'): void ns3::aomdv::RoutingProtocol::DoInitialize() [member function]
    cls.add_method('DoInitialize', 
                   'void', 
                   [], 
                   visibility='protected', is_virtual=True)
...
def register_Ns3AomdvRoutingTable_methods(root_module, cls):
    ## aomdv-rtable.h (module 'aomdv'): ns3::aomdv::RoutingTable::RoutingTable(ns3::aomdv::RoutingTable const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::aomdv::RoutingTable const &', 'arg0')])
    ## aomdv-rtable.h (module 'aomdv'): ns3::aomdv::RoutingTable::RoutingTable(ns3::Time t) [constructor]
    cls.add_constructor([param('ns3::Time', 't')])
    ## aomdv-rtable.h (module 'aomdv'): bool ns3::aomdv::RoutingTable::AddRoute(ns3::aomdv::RoutingTableEntry & r) [member function]
    cls.add_method('AddRoute', 
                   'bool', 
                   [param('ns3::aomdv::RoutingTableEntry &', 'r')])
    ## aomdv-rtable.h (module 'aomdv'): void ns3::aomdv::RoutingTable::Clear() [member function]
    cls.add_method('Clear', 
                   'void', 
                   [])
    ## aomdv-rtable.h (module 'aomdv'): void ns3::aomdv::RoutingTable::DeleteAllRoutesFromInterface(ns3::Ipv4InterfaceAddress iface) [member function]
    cls.add_method('DeleteAllRoutesFromInterface', 
                   'void', 
                   [param('ns3::Ipv4InterfaceAddress', 'iface')])
    ## aomdv-rtable.h (module 'aomdv'): bool ns3::aomdv::RoutingTable::DeleteRoute(ns3::Ipv4Address dst) [member function]
    cls.add_method('DeleteRoute', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst')])
    ## aomdv-rtable.h (module 'aomdv'): ns3::Time ns3::aomdv::RoutingTable::GetBadLinkLifetime() const [member function]
    cls.add_method('GetBadLinkLifetime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## aomdv-rtable.h (module 'aomdv'): void ns3::aomdv::RoutingTable::GetListOfDestinationWithNextHop(ns3::Ipv4Address nextHop, std::map<ns3::Ipv4Address, unsigned int, std::less<ns3::Ipv4Address>, std::allocator<std::pair<ns3::Ipv4Address const, unsigned int> > > & unreachable) [member function]
    ...
    ## aomdv-rtable.h (module 'aomdv'): void ns3::aomdv::RoutingTable::InvalidateRoutesWithDst(std::map<ns3::Ipv4Address, unsigned int, std::less<ns3::Ipv4Address>, std::allocator<std::pair<ns3::Ipv4Address const, unsigned int> > > const & unreachable) [member function]
    cls.add_method('InvalidateRoutesWithDst', 
                   'void', 
                   [param('std::map< ns3::Ipv4Address, unsigned int > const &', 'unreachable')])
    ## aomdv-rtable.h (module 'aomdv'): bool ns3::aomdv::RoutingTable::LookupRoute(ns3::Ipv4Address dst, ns3::aomdv::RoutingTableEntry & rt) [member function]
    cls.add_method('LookupRoute', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst'), param('ns3::aomdv::RoutingTableEntry &', 'rt')])
    ## aomdv-rtable.h (module 'aomdv'): bool ns3::aomdv::RoutingTable::LookupValidRoute(ns3::Ipv4Address dst, ns3::aomdv::RoutingTableEntry & rt) [member function]
    cls.add_method('LookupValidRoute', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst'), param('ns3::aomdv::RoutingTableEntry &', 'rt')])
    ## aomdv-rtable.h (module 'aomdv'): bool ns3::aomdv::RoutingTable::MarkLinkAsUnidirectional(ns3::Ipv4Address neighbor, ns3::Time blacklistTimeout) [member function]
    cls.add_method('MarkLinkAsUnidirectional', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'neighbor'), param('ns3::Time', 'blacklistTimeout')])
    ## aomdv-rtable.h (module 'aomdv'): void ns3::aomdv::RoutingTable::Print(ns3::Ptr<ns3::OutputStreamWrapper> stream) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('ns3::Ptr< ns3::OutputStreamWrapper >', 'stream')], 
                   is_const=True)
    ## aomdv-rtable.h (module 'aomdv'): void ns3::aomdv::RoutingTable::Purge() [member function]
    cls.add_method('Purge', 
                   'void', 
                   [])
    ## aomdv-rtable.h (module 'aomdv'): void ns3::aomdv::RoutingTable::SetBadLinkLifetime(ns3::Time t) [member function]
    cls.add_method('SetBadLinkLifetime', 
                   'void', 
                   [param('ns3::Time', 't')])
    ## aomdv-rtable.h (module 'aomdv'): bool ns3::aomdv::RoutingTable::SetEntryState(ns3::Ipv4Address dst, ns3::aomdv::RouteFlags state) [member function]
    cls.add_method('SetEntryState', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst'), param('ns3::aomdv::RouteFlags', 'state')])
    ## aomdv-rtable.h (module 'aomdv'): bool ns3::aomdv::RoutingTable::Update(ns3::aomdv::RoutingTableEntry & rt) [member function]
    cls.add_method('Update', 
                   'bool', 
                   [param('ns3::aomdv::RoutingTableEntry &', 'rt')])
    return

def register_Ns3AomdvRoutingTableEntry_methods(root_module, cls):
    ## aomdv-rtable.h (module 'aomdv'): ns3::aomdv::RoutingTableEntry::RoutingTableEntry(ns3::aomdv::RoutingTableEntry const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::aomdv::RoutingTableEntry const &', 'arg0')])
    ## aomdv-rtable.h (module 'aomdv'): ns3::aomdv::RoutingTableEntry::RoutingTableEntry(ns3::Ptr<ns3::NetDevice> dev=0, ns3::Ipv4Address dst=ns3::Ipv4Address(), bool vSeqNo=false, uint32_t m_seqNo=0, ns3::Ipv4InterfaceAddress iface=ns3::Ipv4InterfaceAddress(), uint16_t hops=0, ns3::Ipv4Address nextHop=ns3::Ipv4Address(), ns3::Time lifetime=ns3::Simulator::Now( )) [constructor]
    ...
    ## aomdv-rtable.h (module 'aomdv'): void ns3::aomdv::RoutingTableEntry::DeleteAllPrecursors() [member function]
    cls.add_method('DeleteAllPrecursors', 
                   'void', 
                   [])
    ## aomdv-rtable.h (module 'aomdv'): bool ns3::aomdv::RoutingTableEntry::DeletePrecursor(ns3::Ipv4Address id) [member function]
    cls.add_method('DeletePrecursor', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'id')])
    ## aomdv-rtable.h (module 'aomdv'): ns3::Time ns3::aomdv::RoutingTableEntry::GetBlacklistTimeout() const [member function]
    cls.add_method('GetBlacklistTimeout', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## aomdv-rtable.h (module 'aomdv'): ns3::Ipv4Address ns3::aomdv::RoutingTableEntry::GetDestination() const [member function]
    cls.add_method('GetDestination', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## aomdv-rtable.h (module 'aomdv'): ns3::aomdv::RouteFlags ns3::aomdv::RoutingTableEntry::GetFlag() const [member function]
    cls.add_method('GetFlag', 
                   'ns3::aomdv::RouteFlags', 
                   [], 
                   is_const=True)
    ## aomdv-rtable.h (module 'aomdv'): uint16_t ns3::aomdv::RoutingTableEntry::GetHop() const [member function]
    cls.add_method('GetHop', 
                   'uint16_t', 
                   [], 
                   is_const=True)
    ## aomdv-rtable.h (module 'aomdv'): ns3::Ipv4InterfaceAddress ns3::aomdv::RoutingTableEntry::GetInterface() const [member function]
    cls.add_method('GetInterface', 
                   'ns3::Ipv4InterfaceAddress', 
                   [], 
                   is_const=True)
    ## aomdv-rtable.h (module 'aomdv'): ns3::Time ns3::aomdv::RoutingTableEntry::GetLifeTime() const [member function]
    cls.add_method('GetLifeTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## aomdv-rtable.h (module 'aomdv'): ns3::Ipv4Address ns3::aomdv::RoutingTableEntry::GetNextHop() const [member function]
    cls.add_method('GetNextHop', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## aomdv-rtable.h (module 'aomdv'): ns3::Ptr<ns3::NetDevice> ns3::aomdv::RoutingTableEntry::GetOutputDevice() const [member function]
    cls.add_method('GetOutputDevice', 
                   'ns3::Ptr< ns3::NetDevice >', 
                   [], 
                   is_const=True)
    ## aomdv-rtable.h (module 'aomdv'): void ns3::aomdv::RoutingTableEntry::GetPrecursors(std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > & prec) const [member function]
    cls.add_method('GetPrecursors', 
                   'void', 
                   [param('std::vector< ns3::Ipv4Address > &', 'prec')], 
                   is_const=True)
    ## aomdv-rtable.h (module 'aomdv'): ns3::Ptr<ns3::Ipv4Route> ns3::aomdv::RoutingTableEntry::GetRoute() const [member function]
    cls.add_method('GetRoute', 
                   'ns3::Ptr< ns3::Ipv4Route >', 
                   [], 
                   is_const=True)
    ## aomdv-rtable.h (module 'aomdv'): uint8_t ns3::aomdv::RoutingTableEntry::GetRreqCnt() const [member function]
    cls.add_method('GetRreqCnt', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## aomdv-rtable.h (module 'aomdv'): uint32_t ns3::aomdv::RoutingTableEntry::GetSeqNo() const [member function]
    cls.add_method('GetSeqNo', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## aomdv-rtable.h (module 'aomdv'): bool ns3::aomdv::RoutingTableEntry::GetValidSeqNo() const [member function]
    cls.add_method('GetValidSeqNo', 
                   'bool', 
                   [], 
                   is_const=True)
    ## aomdv-rtable.h (module 'aomdv'): void ns3::aomdv::RoutingTableEntry::IncrementRreqCnt() [member function]
    cls.add_method('IncrementRreqCnt', 
                   'void', 
                   [])
    ## aomdv-rtable.h (module 'aomdv'): bool ns3::aomdv::RoutingTableEntry::InsertPrecursor(ns3::Ipv4Address id) [member function]
    cls.add_method('InsertPrecursor', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'id')])
    ## aomdv-rtable.h (module 'aomdv'): void ns3::aomdv::RoutingTableEntry::Invalidate(ns3::Time badLinkLifetime) [member function]
    cls.add_method('Invalidate', 
                   'void', 
                   [param('ns3::Time', 'badLinkLifetime')])
    ## aomdv-rtable.h (module 'aomdv'): bool ns3::aomdv::RoutingTableEntry::IsPrecursorListEmpty() const [member function]
    cls.add_method('IsPrecursorListEmpty', 
                   'bool', 
                   [], 
                   is_const=True)
    ## aomdv-rtable.h (module 'aomdv'): bool ns3::aomdv::RoutingTableEntry::IsUnidirectional() const [member function]
    cls.add_method('IsUnidirectional', 
                   'bool', 
                   [], 
                   is_const=True)
    ## aomdv-rtable.h (module 'aomdv'): bool ns3::aomdv::RoutingTableEntry::LookupPrecursor(ns3::Ipv4Address id) [member function]
    cls.add_method('LookupPrecursor', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'id')])
    ## aomdv-rtable.h (module 'aomdv'): void ns3::aomdv::RoutingTableEntry::Print(ns3::Ptr<ns3::OutputStreamWrapper> stream) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('ns3::Ptr< ns3::OutputStreamWrapper >', 'stream')], 
                   is_const=True)
    ## aomdv-rtable.h (module 'aomdv'): void ns3::aomdv::RoutingTableEntry::SetBalcklistTimeout(ns3::Time t) [member function]
    cls.add_method('SetBalcklistTimeout', 
                   'void', 
                   [param('ns3::Time', 't')])
    ## aomdv-rtable.h (module 'aomdv'): void ns3::aomdv::RoutingTableEntry::SetFlag(ns3::aomdv::RouteFlags flag) [member function]
    cls.add_method('SetFlag', 
                   'void', 
                   [param('ns3::aomdv::RouteFlags', 'flag')])
    ## aomdv-rtable.h (module 'aomdv'): void ns3::aomdv::RoutingTableEntry::SetHop(uint16_t hop) [member function]
    cls.add_method('SetHop', 
                   'void', 
                   [param('uint16_t', 'hop')])
    ## aomdv-rtable.h (module 'aomdv'): void ns3::aomdv::RoutingTableEntry::SetInterface(ns3::Ipv4InterfaceAddress iface) [member function]
    cls.add_method('SetInterface', 
                   'void', 
                   [param('ns3::Ipv4InterfaceAddress', 'iface')])
    ## aomdv-rtable.h (module 'aomdv'): void ns3::aomdv::RoutingTableEntry::SetLifeTime(ns3::Time lt) [member function]
    cls.add_method('SetLifeTime', 
                   'void', 
                   [param('ns3::Time', 'lt')])
    ## aomdv-rtable.h (module 'aomdv'): void ns3::aomdv::RoutingTableEntry::SetNextHop(ns3::Ipv4Address nextHop) [member function]
    cls.add_method('SetNextHop', 
                   'void', 
                   [param('ns3::Ipv4Address', 'nextHop')])
    ## aomdv-rtable.h (module 'aomdv'): void ns3::aomdv::RoutingTableEntry::SetOutputDevice(ns3::Ptr<ns3::NetDevice> dev) [member function]
    cls.add_method('SetOutputDevice', 
                   'void', 
                   [param('ns3::Ptr< ns3::NetDevice >', 'dev')])
    ## aomdv-rtable.h (module 'aomdv'): void ns3::aomdv::RoutingTableEntry::SetRoute(ns3::Ptr<ns3::Ipv4Route> r) [member function]
    cls.add_method('SetRoute', 
                   'void', 
                   [param('ns3::Ptr< ns3::Ipv4Route >', 'r')])
    ## aomdv-rtable.h (module 'aomdv'): void ns3::aomdv::RoutingTableEntry::SetRreqCnt(uint8_t n) [member function]
    cls.add_method('SetRreqCnt', 
                   'void', 
                   [param('uint8_t', 'n')])
    ## aomdv-rtable.h (module 'aomdv'): void ns3::aomdv::RoutingTableEntry::SetSeqNo(uint32_t sn) [member function]
    cls.add_method('SetSeqNo', 
                   'void', 
                   [param('uint32_t', 'sn')])
    ## aomdv-rtable.h (module 'aomdv'): void ns3::aomdv::RoutingTableEntry::SetUnidirectional(bool u) [member function]
    cls.add_method('SetUnidirectional', 
                   'void', 
                   [param('bool', 'u')])
    ## aomdv-rtable.h (module 'aomdv'): void ns3::aomdv::RoutingTableEntry::SetValidSeqNo(bool s) [member function]
    cls.add_method('SetValidSeqNo', 
                   'void', 
                   [param('bool', 's')])
    ## aomdv-rtable.h (module 'aomdv'): ns3::aomdv::RoutingTableEntry::m_ackTimer [variable]
    cls.add_instance_attribute('m_ackTimer', 'ns3::Timer', is_const=False)
    return

def register_Ns3AomdvRrepAckHeader_methods(root_module, cls):
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## aomdv-packet.h (module 'aomdv'): ns3::aomdv::RrepAckHeader::RrepAckHeader(ns3::aomdv::RrepAckHeader const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::aomdv::RrepAckHeader const &', 'arg0')])
    ## aomdv-packet.h (module 'aomdv'): ns3::aomdv::RrepAckHeader::RrepAckHeader() [constructor]
    cls.add_constructor([])
    ## aomdv-packet.h (module 'aomdv'): uint32_t ns3::aomdv::RrepAckHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## aomdv-packet.h (module 'aomdv'): ns3::TypeId ns3::aomdv::RrepAckHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## aomdv-packet.h (module 'aomdv'): uint32_t ns3::aomdv::RrepAckHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## aomdv-packet.h (module 'aomdv'): static ns3::TypeId ns3::aomdv::RrepAckHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## aomdv-packet.h (module 'aomdv'): void ns3::aomdv::RrepAckHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## aomdv-packet.h (module 'aomdv'): void ns3::aomdv::RrepAckHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
...
def register_Ns3AomdvRrepHeader_methods(root_module, cls):
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## aomdv-packet.h (module 'aomdv'): ns3::aomdv::RrepHeader::RrepHeader(ns3::aomdv::RrepHeader const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::aomdv::RrepHeader const &', 'arg0')])
    ## aomdv-packet.h (module 'aomdv'): ns3::aomdv::RrepHeader::RrepHeader(uint8_t prefixSize=0, uint8_t hopCount=0, ns3::Ipv4Address dst=ns3::Ipv4Address(), uint32_t dstSeqNo=0, ns3::Ipv4Address origin=ns3::Ipv4Address(), ns3::Time lifetime=ns3::MilliSeconds( )) [constructor]
    ...
    ## aomdv-packet.h (module 'aomdv'): uint32_t ns3::aomdv::RrepHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## aomdv-packet.h (module 'aomdv'): bool ns3::aomdv::RrepHeader::GetAckRequired() const [member function]
    cls.add_method('GetAckRequired', 
                   'bool', 
                   [], 
                   is_const=True)
    ## aomdv-packet.h (module 'aomdv'): ns3::Ipv4Address ns3::aomdv::RrepHeader::GetDst() const [member function]
    cls.add_method('GetDst', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## aomdv-packet.h (module 'aomdv'): uint32_t ns3::aomdv::RrepHeader::GetDstSeqno() const [member function]
    cls.add_method('GetDstSeqno', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## aomdv-packet.h (module 'aomdv'): uint8_t ns3::aomdv::RrepHeader::GetHopCount() const [member function]
    cls.add_method('GetHopCount', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## aomdv-packet.h (module 'aomdv'): ns3::TypeId ns3::aomdv::RrepHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## aomdv-packet.h (module 'aomdv'): ns3::Time ns3::aomdv::RrepHeader::GetLifeTime() const [member function]
    cls.add_method('GetLifeTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## aomdv-packet.h (module 'aomdv'): ns3::Ipv4Address ns3::aomdv::RrepHeader::GetOrigin() const [member function]
    cls.add_method('GetOrigin', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## aomdv-packet.h (module 'aomdv'): uint8_t ns3::aomdv::RrepHeader::GetPrefixSize() const [member function]
    cls.add_method('GetPrefixSize', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## aomdv-packet.h (module 'aomdv'): uint32_t ns3::aomdv::RrepHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## aomdv-packet.h (module 'aomdv'): static ns3::TypeId ns3::aomdv::RrepHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## aomdv-packet.h (module 'aomdv'): void ns3::aomdv::RrepHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## aomdv-packet.h (module 'aomdv'): void ns3::aomdv::RrepHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## aomdv-packet.h (module 'aomdv'): void ns3::aomdv::RrepHeader::SetAckRequired(bool f) [member function]
    cls.add_method('SetAckRequired', 
                   'void', 
                   [param('bool', 'f')])
    ## aomdv-packet.h (module 'aomdv'): void ns3::aomdv::RrepHeader::SetDst(ns3::Ipv4Address a) [member function]
    cls.add_method('SetDst', 
                   'void', 
                   [param('ns3::Ipv4Address', 'a')])
    ## aomdv-packet.h (module 'aomdv'): void ns3::aomdv::RrepHeader::SetDstSeqno(uint32_t s) [member function]
    cls.add_method('SetDstSeqno', 
                   'void', 
                   [param('uint32_t', 's')])
    ## aomdv-packet.h (module 'aomdv'): void ns3::aomdv::RrepHeader::SetHello(ns3::Ipv4Address src, uint32_t srcSeqNo, ns3::Time lifetime) [member function]
    cls.add_method('SetHello', 
                   'void', 
                   [param('ns3::Ipv4Address', 'src'), param('uint32_t', 'srcSeqNo'), param('ns3::Time', 'lifetime')])
    ## aomdv-packet.h (module 'aomdv'): void ns3::aomdv::RrepHeader::SetHopCount(uint8_t count) [member function]
    cls.add_method('SetHopCount', 
                   'void', 
                   [param('uint8_t', 'count')])
    ## aomdv-packet.h (module 'aomdv'): void ns3::aomdv::RrepHeader::SetLifeTime(ns3::Time t) [member function]
    cls.add_method('SetLifeTime', 
                   'void', 
                   [param('ns3::Time', 't')])
    ## aomdv-packet.h (module 'aomdv'): void ns3::aomdv::RrepHeader::SetOrigin(ns3::Ipv4Address a) [member function]
    cls.add_method('SetOrigin', 
                   'void', 
                   [param('ns3::Ipv4Address', 'a')])
    ## aomdv-packet.h (module 'aomdv'): void ns3::aomdv::RrepHeader::SetPrefixSize(uint8_t sz) [member function]
    cls.add_method('SetPrefixSize', 
                   'void', 
                   [param('uint8_t', 'sz')])
    return

def register_Ns3AomdvRreqHeader_methods(root_module, cls):
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## aomdv-packet.h (module 'aomdv'): ns3::aomdv::RreqHeader::RreqHeader(ns3::aomdv::RreqHeader const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::aomdv::RreqHeader const &', 'arg0')])
    ## aomdv-packet.h (module 'aomdv'): ns3::aomdv::RreqHeader::RreqHeader(uint8_t flags=0, uint8_t reserved=0, uint8_t hopCount=0, uint32_t requestID=0, ns3::Ipv4Address dst=ns3::Ipv4Address(), uint32_t dstSeqNo=0, ns3::Ipv4Address origin=ns3::Ipv4Address(), uint32_t originSeqNo=0) [constructor]
    ...
    ## aomdv-packet.h (module 'aomdv'): uint32_t ns3::aomdv::RreqHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## aomdv-packet.h (module 'aomdv'): bool ns3::aomdv::RreqHeader::GetDestinationOnly() const [member function]
    cls.add_method('GetDestinationOnly', 
                   'bool', 
                   [], 
                   is_const=True)
    ## aomdv-packet.h (module 'aomdv'): ns3::Ipv4Address ns3::aomdv::RreqHeader::GetDst() const [member function]
    cls.add_method('GetDst', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## aomdv-packet.h (module 'aomdv'): uint32_t ns3::aomdv::RreqHeader::GetDstSeqno() const [member function]
    cls.add_method('GetDstSeqno', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## aomdv-packet.h (module 'aomdv'): bool ns3::aomdv::RreqHeader::GetGratiousRrep() const [member function]
    cls.add_method('GetGratiousRrep', 
                   'bool', 
                   [], 
                   is_const=True)
    ## aomdv-packet.h (module 'aomdv'): uint8_t ns3::aomdv::RreqHeader::GetHopCount() const [member function]
    cls.add_method('GetHopCount', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## aomdv-packet.h (module 'aomdv'): uint32_t ns3::aomdv::RreqHeader::GetId() const [member function]
    cls.add_method('GetId', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## aomdv-packet.h (module 'aomdv'): ns3::TypeId ns3::aomdv::RreqHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## aomdv-packet.h (module 'aomdv'): ns3::Ipv4Address ns3::aomdv::RreqHeader::GetOrigin() const [member function]
    cls.add_method('GetOrigin', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## aomdv-packet.h (module 'aomdv'): uint32_t ns3::aomdv::RreqHeader::GetOriginSeqno() const [member function]
    cls.add_method('GetOriginSeqno', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## aomdv-packet.h (module 'aomdv'): uint32_t ns3::aomdv::RreqHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## aomdv-packet.h (module 'aomdv'): static ns3::TypeId ns3::aomdv::RreqHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## aomdv-packet.h (module 'aomdv'): bool ns3::aomdv::RreqHeader::GetUnknownSeqno() const [member function]
    cls.add_method('GetUnknownSeqno', 
                   'bool', 
                   [], 
                   is_const=True)
    ## aomdv-packet.h (module 'aomdv'): void ns3::aomdv::RreqHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## aomdv-packet.h (module 'aomdv'): void ns3::aomdv::RreqHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## aomdv-packet.h (module 'aomdv'): void ns3::aomdv::RreqHeader::SetDestinationOnly(bool f) [member function]
    cls.add_method('SetDestinationOnly', 
                   'void', 
                   [param('bool', 'f')])
    ## aomdv-packet.h (module 'aomdv'): void ns3::aomdv::RreqHeader::SetDst(ns3::Ipv4Address a) [member function]
    cls.add_method('SetDst', 
                   'void', 
                   [param('ns3::Ipv4Address', 'a')])
    ## aomdv-packet.h (module 'aomdv'): void ns3::aomdv::RreqHeader::SetDstSeqno(uint32_t s) [member function]
    cls.add_method('SetDstSeqno', 
                   'void', 
                   [param('uint32_t', 's')])
    ## aomdv-packet.h (module 'aomdv'): void ns3::aomdv::RreqHeader::SetGratiousRrep(bool f) [member function]
    cls.add_method('SetGratiousRrep', 
                   'void', 
                   [param('bool', 'f')])
    ## aomdv-packet.h (module 'aomdv'): void ns3::aomdv::RreqHeader::SetHopCount(uint8_t count) [member function]
    cls.add_method('SetHopCount', 
                   'void', 
                   [param('uint8_t', 'count')])
    ## aomdv-packet.h (module 'aomdv'): void ns3::aomdv::RreqHeader::SetId(uint32_t id) [member function]
    cls.add_method('SetId', 
                   'void', 
                   [param('uint32_t', 'id')])
    ## aomdv-packet.h (module 'aomdv'): void ns3::aomdv::RreqHeader::SetOrigin(ns3::Ipv4Address a) [member function]
    cls.add_method('SetOrigin', 
                   'void', 
                   [param('ns3::Ipv4Address', 'a')])
    ## aomdv-packet.h (module 'aomdv'): void ns3::aomdv::RreqHeader::SetOriginSeqno(uint32_t s) [member function]
    cls.add_method('SetOriginSeqno', 
                   'void', 
                   [param('uint32_t', 's')])
    ## aomdv-packet.h (module 'aomdv'): void ns3::aomdv::RreqHeader::SetUnknownSeqno(bool f) [member function]
    cls.add_method('SetUnknownSeqno', 
                   'void', 
                   [param('bool', 'f')])
    return

def register_Ns3AomdvTypeHeader_methods(root_module, cls):
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## aomdv-packet.h (module 'aomdv'): ns3::aomdv::TypeHeader::TypeHeader(ns3::aomdv::TypeHeader const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::aomdv::TypeHeader const &', 'arg0')])
    ## aomdv-packet.h (module 'aomdv'): ns3::aomdv::TypeHeader::TypeHeader(ns3::aomdv::MessageType t=::ns3::aomdv::AOMDVTYPE_RREQ) [constructor]
    cls.add_constructor([param('ns3::aomdv::MessageType', 't', default_value='::ns3::aomdv::AOMDVTYPE_RREQ')])
    ## aomdv-packet.h (module 'aomdv'): uint32_t ns3::aomdv::TypeHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## aomdv-packet.h (module 'aomdv'): ns3::aomdv::MessageType ns3::aomdv::TypeHeader::Get() const [member function]
    cls.add_method('Get', 
                   'ns3::aomdv::MessageType', 
                   [], 
                   is_const=True)
    ## aomdv-packet.h (module 'aomdv'): ns3::TypeId ns3::aomdv::TypeHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## aomdv-packet.h (module 'aomdv'): uint32_t ns3::aomdv::TypeHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## aomdv-packet.h (module 'aomdv'): static ns3::TypeId ns3::aomdv::TypeHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## aomdv-packet.h (module 'aomdv'): bool ns3::aomdv::TypeHeader::IsValid() const [member function]
    cls.add_method('IsValid', 
                   'bool', 
                   [], 
                   is_const=True)
    ## aomdv-packet.h (module 'aomdv'): void ns3::aomdv::TypeHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## aomdv-packet.h (module 'aomdv'): void ns3::aomdv::TypeHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
...
def register_functions(root_module):
    ...
    register_functions_ns3_aomdv(module.get_submodule('aomdv'), root_module)
    return
...
def register_functions_ns3_aomdv(module, root_module):
    return
